    ...
    MESSANGER: {
      Message: {
        ...
        operatorContent: {
          ...
          background: chat.theme.messageOperatorBackgroundColor || '#e1e1e1',
          color: chat.theme.messageOperatorForegroundColor || '#000000',
          float: 'right',
          textAlign: 'right',
        },
        userContent: {
          ...
          float: 'left',
          textAlign: 'left',
          background: chat.theme.messageUserBackgroundColor || '#0a6bef',
          marginTop: '0',
          marginLeft: '4px',
          borderRadius: '10px 10px 10px 0',
          padding: '6px',
          color: chat.theme.messageUserForegroundColor || 'white',
        },
      },
      MessageList: {
        messages: {
      ...
      Input: {
        input: {
          ...
          border: 0,
          borderRight: '1px solid #ccc',
          borderTop: `1px solid ${chat.theme.messangeInputBorderColor || '#ddd'}`,
          backgroundColor: chat.theme.messangeInputBackgroundColor || '#fff',
          padding: '8px',
          color: chat.theme.messageInputForegroundColor || '#222',
          fontSize: '11px',
          resize: 'none',
          outline: 0,
        },
      ...
      Chat: {
        ...
        box: {
          ...
          right: 0,
          bottom: 0,
          backgroundColor: chat.theme.messageListBackgroundColor || '#ffffff',
        },
        header: {
          display: 'block',
          width: '100%',
          ...
          color: chat.theme.chatForegroundColor || 'white',
          background: chat.theme.chatPrimaryColor || '#72a0e5',
        },
        icon: {
          border: 0,
          float: 'right',
          ...
          fontWeight: '800',
          cursor: 'pointer',
          color: chat.theme.chatSecondaryColor || 'rgba(255,255,255,0.5)',
    ...
    FLOAT: {
      Message: {
        ...
        operatorContent: {
          ...
          float: 'left',
          textAlign: 'left',
          background: chat.theme.messageOperatorBackgroundColor || '#ffffff',
          color: chat.theme.messageOperatorForegroundColor || '#000000',
          marginTop: '4px',
          marginLeft: '4px',
          boxShadow: '#dddddd 1px 1px 8px 0',
